...
from .Qwen_solution_prompt import (
    COT_TASK_DESC,
    CRITIQUE_TASK_DESC,
    REWRITE_TASK_DESC,
    COT_FORMAT_STR,
...
class Env(CoTEnv):
    def __init__(
        ...
        if 'Qwen' in llm_gen_fn.modelname():
            ...
            from .Llama_solution_prompt import (
                COT_TASK_DESC,
                CRITIQUE_TASK_DESC,
                REWRITE_TASK_DESC,
                COT_FORMAT_STR,
            ...
            from .Gemma_solution_prompt import (
                COT_TASK_DESC,
                CRITIQUE_TASK_DESC,
                REWRITE_TASK_DESC,
                COT_FORMAT_STR,
        ...
        self.num_reviews = 1 
        self.num_rewrite = config["num_sample"]
        self.max_new_tokens_answer = 10000
        self.max_new_tokens_review = 10000
        self.max_depth = 4
    ...
    def update_legal_actions(self):
        ...
        for text in review_texts:
            ...
            total_completion += result.completion_tokens
            for _ in range(self.num_rewrite):
    ...
    def get_done_and_info(self):
        ...
        truncated = terminated = len(self.action_history) > self.config["num_refine"]
