...
class Node(object):
    ...
    def update(self, value: float) -> None:
        ...
        """
        self._visit_count += 1
        self._value_sum += value # self._value_sum init=0
...
class LanguageNode(Node):
    ...
    def rewrite_action(self,last_action, refine_tokens):
        self.last_action = last_action
        self.num_generated_token += refine_tokens
    def return_tokens(self):
        return self.num_generated_token
...
class SearchTree:
    ...
    def _ucb_score(self, parent: Node, child: Node) -> float:
        ...
        """
        pb_c = (
            math.log((parent.visit_count + self._pb_c_base + 1) / self._pb_c_base)# self._pb_c_base=19652
            + self._pb_c_init # self._pb_c_init = 1.25
        )
